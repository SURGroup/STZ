...
int main(int argc,char **argv) {
	...
	shear_sim sim(m,160,-bx,bx,-1,1,mu,K,visc,0,0,t_scale,tmult,adapt_fac,u_bdry,&stz,fn);
	...
	qs?sim.solve_quasistatic(dur[run]/sca,frs[run],nquas[run]):sim.solve(dur[run]/sca,frs[run]);

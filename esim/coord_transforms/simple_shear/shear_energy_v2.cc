...
int main(int argc,char **argv) {
    ...
    double kappa_=0;
    double Omegaeps0_ = 100;      // Activation volume and local strain product (A^3)
    ...
    while(i<argc) {
        ...
        else if(read_arg(argv,"Omegaeps0",i,argc,Omegaeps0_,"activation volume and local strain product"," Angstroms^3")) {}
    ...
    const double Omegaeps0=Omegaeps0_*1e-30*s_y*1e9/(TZ*kB);

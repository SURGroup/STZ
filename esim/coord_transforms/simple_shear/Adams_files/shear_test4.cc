...
int main(int argc,char **argv) {
	...
	shear_sim sim(320,320,0,1,0,1,mu,K,visc,chi_diff,chi_len,t_scale,tmult,adapt_fac,u_bdry,0,&stz_a,qs?qfn:dfn);

	sim.initialize_tracers(320,320);
    	
	// Code to read in a text file as the initial chi field
	//ifstream file;
	//file.open("/research/research_nanocomposite2/stochastic/coarsegrained/sig_5_rand2");//strain_diff_8x8
	//if(!file.is_open()) {

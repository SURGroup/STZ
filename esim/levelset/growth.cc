...
int main() {
	...
	// Initialize the phi function to be equal to some arbitrary boundary.
	// The only thing that matters is the position of the contour phi(x)=0,
	// which will be used as the starting point of the fast marching
	// method.
